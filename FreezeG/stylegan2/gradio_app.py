...
if __name__ == "__main__":
    ...
    parser.add_argument("--source_ckpt", type=str, default='./checkpoint/stylegan2-ffhq-config-f.pt')
    parser.add_argument("--target_ckpt", type=str, default='./checkpoint/043000.pt')
    parser.add_argument("--target_factors", type=str, default='./factor.pt')
    ...
    gradio.Interface(fn=sampler.create_sample, inputs=gradio_inputs, outputs=gradio.outputs.Image(), live=True, title='FreezeG').launch(share=True)